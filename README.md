...
**当前版本：0.4.0。** 支持 SE2 实心亮十字；不自动识别 InLens 浮雕风格。
...
文件名格式为 `数字marker编号-行.列.tif`，例如 `0101-3.4.tif`。
...
- 不再支持 `sample(3.5,2).tif` 或尚未实施的 `0101_r3c4_01.tif`。
